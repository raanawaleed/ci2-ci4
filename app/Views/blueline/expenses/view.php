          ...
          <div class="row">
            ...
            <a href="<?=base_url()?>estimates/update/<?=$estimate->id;?>/view" class="btn btn-primary" data-toggle="mainmodal"><i class="fa fa-edit visible-xs" title="Modifier"></i><span class="hidden-xs"><?=$this->lang->line('application_edit_estimate');?></span></a>
		...
		<td class="option" style="text-align:left;" width="8%">
				        ...
				        <a href="<?=base_url()?>estimates/item_update/<?=$estimate->invoice_has_items[$i]->id;?>" title="<?=$this->lang->line('application_edit');?>" class="btn-option" data-toggle="mainmodal"><i class="fa fa-edit"></i></a>
			</td>
