            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="stdpad-small blue">
                    ...
                    <div class="stats two"> 
						...
						<div class="number" id="number2"><?php if(empty($paymentsoutstanding[0]->summary)){echo display_money(0, $core_settings->currency, 0);}else{echo display_money($paymentsoutstanding[0]->summary, $core_settings->currency, 2); } ?>
						</div> 
						<div class="text"><?=$this->lang->line('application_outstanding_payments');?></div>
                    </div>
                       </div>
                        </div>
