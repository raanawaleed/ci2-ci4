...
<div class="col-md-9">
		...
		<div class="table-head"><?=$this->lang->line('application_database_backups');?> <span class="pull-right"><a href="<?=base_url()?>settings/mysql_backup" class="btn btn-primray"><i class="fa fa-download"></i> <?=$this->lang->line('application_backup_database');?></a></span></div>
