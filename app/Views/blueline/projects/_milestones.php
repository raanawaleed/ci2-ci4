...
<div class="form-group">
	...
	<input class="form-control datepicker not-required" name="start_date" id="start_date" type="text" value="<?php if(isset($milestone)){echo $milestone->start_date;} ?>" data-date-format="yyyy-mm-dd"/>
</div>
<div class="form-group">
	<label for="due_date"><?=$this->lang->line('application_due_date');?></label>
	<input class="form-control datepicker-linked not-required" name="due_date" id="due_date" type="text" value="<?php if(isset($milestone)){echo $milestone->due_date;} ?>" data-date-format="yyyy-mm-dd"/>
</div>
