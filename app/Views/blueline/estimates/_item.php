...
<div class="form-group">
	...
	<input id="name" name="name" type="text" class="form-control"  value="<?=$estimate_has_items->name;?>"  />
</div>
<div class="form-group">
	<label for="type"><?=$this->lang->line('application_family');?></label>
	<input id="type" type="text" name="type" class=" form-control"  value="<?=$estimate_has_items->type;?>"  />
</div>
<div class="form-group">
	<label for="value"><?=$this->lang->line('application_value');?></label>
	<input id="value" type="text" name="value" class="form-control number"  value="<?php echo display_money($estimate_has_items->value,"",$chiffre);?>" />
</div>
...
<div class="row">
	<div class="col-md-6 col-xs-12">
		<div class="form-group">
			...
			<input id="amount" type="number" min="0" step="0.001" name="amount" class="required form-control number" value="<?php if(isset($estimate_has_items)){ echo $estimate_has_items->amount; }else{echo '1';} ?>"  />
		</div>
	</div>
	<div class="col-md-6 col-xs-12">
		<div class="form-group">
			...
			<?php
				...
				echo form_dropdown('unit', $options, $estimate_has_items->unit, 'id="unit" style="width:100%" class="chosen-select"');
			?>
		</div>
	</div>
</div>
