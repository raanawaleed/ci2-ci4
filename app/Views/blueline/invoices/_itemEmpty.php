...
<div class="form-group">
        ...
        <input id="name" name="name" type="text" class="form-control"  value="<?=$invoice_has_items->name;?>" required />
</div>
<div class="form-group">
        <label for="value"><?=$this->lang->line('application_prix_unitaire');?></label>
        <input id="value" type="text" name="value" class="required form-control number"  value="<?=$invoice_has_items->value;?>" required />
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<select name="tva" id="TVA" class="chosen-select" required >
		<?php $currenttva=$invoice_has_items->tva;
		foreach($tva as $key){ 
...
<div class="row">
	<div class="col-md-6 col-xs-12">
		<div class="form-group">
			...
			<input id="amount"  type="number" min="0" step="0.001" name="amount" class="form-control number comma-to-point"  value="<?php if(isset($invoice_has_items)){ echo $invoice_has_items->amount; }else{echo '1';} ?>"  required />
		</div>
	</div>
	<div class="col-md-6 col-xs-12">
		<div class="form-group">
			...
			<?php
				...
				echo form_dropdown('unit', $options, $invoice_has_items->unit, 'style="width:100%" class="chosen-select"');
			?>
		</div>
	</div>
</div>
