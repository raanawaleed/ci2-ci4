$(document).ready(function(){ 
   ...
   /* $(".scroll-content-2").mCustomScrollbar({theme:"dark-2",
    ...
    $(".chosen-select").chosen({scroll_to_highlighted: false, disable_search_threshold: 4, enable_split_word_search: true, search_contains: true, width: "100%", display_disabled_options:false,
	  case_sensitive_search:true, no_results_text: "Pas de résultat trouvé"});
